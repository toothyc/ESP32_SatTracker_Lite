...
float myLat = 54.23508611644214, myLong = -0.680980682373047, myAlt = 64 ;   	//Antenna latitude, longitude and altitude . (fixed in lite version)
//float myLat = 43.5156, myLong = 1.49806, myAlt = 230 ;
